...
import com.example.superecipe.databinding.CategoryRvItemBinding

class CategoryAdapter(var dataList: ArrayList<Recipe>, var context: Context) :
    RecyclerView.Adapter<CategoryAdapter.ViewHolder>() {

    inner class ViewHolder(var binding: CategoryRvItemBinding) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        Glide.with(context).load(dataList[position].img).into(holder.binding.categoryImg)
        holder.binding.categoryName.text = dataList[position].tittle
